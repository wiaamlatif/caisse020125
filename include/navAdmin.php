<?php
      ...
      if(in_array($clickedNav,range(21,22))){$clickedNav=7;}
...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
      ...
      <a href="http://localhost:8000/" class="btn"><h3><span class="badge text-bg-dark text-white">Front side</span></h3></a>

      <a href="http://localhost:8000/admin/sell/x_z/detailItem.php?id=1">DetailsItem</a>
  </div>
</nav>